...
fileopen = open(r"C:\Users\Gigi\PycharmProjects\1LifeCampaign\parser\missionReport(2021-04-23_16-52-50)[0].txt")
print(fileopen)
...
# colpire un oggetto con un proiettile / bomba
...
# danno (il danno può essere negativo - un bug?)
...
# decollo (la velocità è maggiore di qualcosa e l'altitudine è superiore a 50 m)
...
# stato di alcune attività nella missione
...
# infa sull'aerodromo e su quale aereo è attaccato ad esso
...
# respawn del giocatore (INAIR: 0 - in aria, 1 - dalla corsia (motore acceso), 2 - dal parcheggio
...
# gruppo di oggetti, con leader ed elenco dei membri
...
# respawn alcuni oggetti di gioco
...
# zone, il numero di aerei in volo per ciascuna coalizione (0, 1, 2, 3, 4, 5, 6, 7) attualmente nella zona
...
# bordi di zona, elenco dei vertici di zona (poligono arbitrario)
...
# versione del sistema di registro?
...
# posizione attuale dell'oggetto
...
# l'inizio del movimento del carro
